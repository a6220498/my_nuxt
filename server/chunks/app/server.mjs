...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-d8fbd4ab.mjs').then((m) => m.default || m)
  }
];
...
const revive_payload_server_kQUYUx3vgQ = /* @__PURE__ */ defineNuxtPlugin({
...
const unhead_ALcEux1jXG = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  setup(nuxtApp) {
...
const plugins = [
  plugin,
  revive_payload_server_kQUYUx3vgQ,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-5152e044.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-7676902b.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.6.0_@types+node@18.0.0_typescript@5.1.3/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.6.0_@types+node@18.0.0_typescript@5.1.3/node_modules/nuxt/dist/app/components/nuxt-root.vue");
